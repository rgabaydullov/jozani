...
/* eslint-disable @typescript-eslint/no-explicit-any */ /* eslint-disable react/display-name */ 


class SimpleDocument extends next_document__WEBPACK_IMPORTED_MODULE_2__["default"] {
    static async getInitialProps(ctx) {
        const stylesheet = new styled_components__WEBPACK_IMPORTED_MODULE_3__.ServerStyleSheet();
        const originalRenderPage = ctx.renderPage;
        try {
            ctx.renderPage = ()=>originalRenderPage({
                    enhanceApp: (App)=>(props)=>stylesheet.collectStyles(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(App, {
                                ...props
                            }))
                })
            ;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SimpleDocument);
...
var __webpack_exports__ = __webpack_require__.X(0, [331], () => (__webpack_exec__(256)));
